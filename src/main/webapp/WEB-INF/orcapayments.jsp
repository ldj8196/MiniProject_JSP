...
<script>
  ...
  document.querySelector("#payment-button").addEventListener("click",()=>{
    paymentWidget.requestPayment({
      ...
      orderName: '견적서명',
      successUrl: 'http://127.0.0.1:8080/Orca_MiniProject/orcapaysuccess.do',
      failUrl: 'http://127.0.0.1:8080/Orca_MiniProject/orcapayments.do',
      customerEmail: 'ldj8196@gmail.com', 
      customerName: '이동준'
