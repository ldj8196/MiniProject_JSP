...
// 127.0.0.1:8080/Orca_MiniProject/api/Client/UpdatePw.json
@WebServlet(urlPatterns = {"/api/Client/UpdatePw.json"})
public class RestOrcaUpdatePwController extends HttpServlet {
