...
@WebServlet(urlPatterns = {"/orcamypageindividualchange.do"})
public class OcraMyPageChangeIndividualController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public OcraMyPageChangeIndividualController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/orca_mypagechangeindividual.jsp").forward(request, response);
	}
